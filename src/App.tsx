                  ...
                  <div className="row h-100 align-items-center g-2">
                    <div className="col-md-4 mb-3 mb-md-0 h-100">
                      <div className="card card-span h-100 text-white">
                        <img
                          ...
                          src="assets/img/gallery/maldives.png"
                          alt="..."
                        />
                        ...
                        <div className="card-body ps-0">
                          <h5 className="fw-bold text-1000 mb-4 text-truncate">
                            Mermaid Beach Resort: The most joyful way to spend
                            your holiday
                          </h5>
                          <div className="d-flex align-items-center justify-content-start">
                            ...
                            <span className="text-900 me-3">Maldives</span>
                            <span className="text-800 fs--1 me-2">
                              <i className="fas fa-calendar" />
                            </span>
                            <span className="text-900">4 days</span>
                          </div>
                    ...
                    <div className="col-md-4 mb-3 mb-md-0 h-100">
                      <div className="card card-span h-100 text-white">
                        ...
                        <div className="card-body ps-0">
                          <h5 className="fw-bold text-1000 mb-4 text-truncate">
                            Bora Bora: Enjoy a romantic cruise tour of at the
                            sunny side of life
                          </h5>
                          <div className="d-flex align-items-center justify-content-start">
                            <span className="text-800 fs--1 me-2">
                    ...
                    <div className="col-md-4 mb-3 mb-md-0 h-100">
                      <div className="card card-span h-100 text-white">
                        ...
                        <div className="card-body ps-0">
                          <h5 className="fw-bold text-1000 mb-4 text-truncate">
                            Fihalhohi Island Resort: Luxury destination without
                            compromise
                          </h5>
                          <div className="d-flex align-items-center justify-content-start">
                            <span className="text-800 fs--1 me-2">
          ...
          <div className="col-6 col-sm-4 col-lg-6">
            <div className="py-7">
              ...
              <ul className="list-unstyled mt-4">
                <li className="mb-2">
                  <a className="text-800 fw-bold text-decoration-none" href="#!">
                    News
                  </a>
                </li>
                <li className="mb-2">
